...
object ProducePvAndUvData {
  ...
  val USERID=0L
  //网站
  val WEBSITE=Array("www.baidu.com","www.taobao.com","www.dangdang.com","www.jd.com","www.suning.com","www.mi.com","www.gome.com")
  //行为
  val ACTION=Array("Regist","Comment","View","Login","Buy","Click","Logout")

  def main(args: Array[String]): Unit = {
   // val pathFileName="./data"
    val pathFileName="E:\\IdeaProject\\sparkDemo\\src\\main\\scala\\com\\zpark\\sparkTools\\data\\pvdc.txt"
    //创建文件
